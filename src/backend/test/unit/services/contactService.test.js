...
describe('listContactsByUserId', () => {
  ...
  it('returns null when no contacts are found', async () => {
  ...
  it('returns the list of contacts when they are found', async () => {
    const contacts = [
...
describe('createNewContact', () => {
    ...
    it('creates a new contact with the provided data', async () => {
  ...
  describe('updateContact', () => {
    ...
    it('updates an existing contact with the provided data', async () => {
    ...
    it('returns null if the contact does not exist', async () => {
  ...
  describe('deleteContact', () => {
    ...
    it('deletes a contact with the provided id and userId', async () => {
    ...
    it('returns null if the contact with the provided id and userId doesn\'t exist', async () => {
      Contacts.findOne.mockResolvedValue(null);
      const result = await deleteContact({ id: 1, userId: 1 });
